...
public class RatingRepository {
    ...
    public boolean existsByTradeAndUser(int tradeId, int userId) {
        String sql = "SELECT id FROM calificaciones WHERE trueque_id = ? AND calificador_id = ?";
    ...
    public int save(Rating rating) {
        String sql = "INSERT INTO calificaciones (trueque_id, calificador_id, calificado_id, puntuacion, comentario) " +
                "VALUES (?, ?, ?, ?, ?)";
        try (Connection conn = DatabaseConfig.getConnection();
    ...
    public List<Rating> findByUserId(int userId) {
        ...
        String sql = "SELECT c.*, u.nombre as calificador_nombre, u.apellido as calificador_apellido " +
